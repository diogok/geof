(ns geof.writers
  ...
  (:import [org.tukaani.xz XZOutputStream LZMAOutputStream LZMA2Options])
...
(defn writer-for-0
  ...
  (cond
    ...
    (re-find #"lz$" output-file) (LZMAOutputStream. (writer-for-1 output-file) (LZMA2Options. LZMA2Options/PRESET_MAX) true)
